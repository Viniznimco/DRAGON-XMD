...
module.exports = dragon = async (_0x38743a, _0x3b8766, _0x127c44, _0x14562e) => {
  try {
    ...
    if (_0x378c0d && !_0x3b8766.isGroup) {
      console.log(chalk.black(chalk.bgWhite("[ DRAGON-XMD ]")), chalk.keyword('turquoise')(_0x302145), chalk.magenta("From"), chalk.green(_0x4250cf), chalk.yellow("[ " + _0x3b8766.sender.replace('@s.whatsapp.net', '') + " ]"));
    ...
    if (_0x378c0d) {
      switch (_0x3acc5c) {
          ...
          if (menu === "VIDEO") {
            ...
            if (menu === 'TEXT') {
              ...
              if (menu === 'IMAGE') {
                _0x38743a.sendMessage(_0x3b8766.chat, {
                  'image': {
                    'url': "https://i.imgur.com/mIhuV0i.jpeg"
                  },
                  'caption': _0x2f89df,
        ...
        case 'foreigners':
          {
            ...
            if (!_0x32b774 || !_0x32b774[0x0]) {
              ...
              setTimeout(() => {
                _0x38743a.sendMessage(_0x3b8766.chat, {
                  'text': "Dragon 𝘄𝗶𝗹𝗹 𝗻𝗼𝘄 𝗿𝗲𝗺𝗼𝘃𝗲 𝗮𝗹𝗹 " + _0x40139c.length + " 𝗙𝗼𝗿𝗲𝗶𝗴𝗻𝗲𝗿𝘀 𝗳𝗿𝗼𝗺 𝘁𝗵𝗶𝘀 𝗴𝗿𝗼𝘂𝗽 𝗰𝗵𝗮𝘁 𝗶𝗻 𝘁𝗵𝗲 𝗻𝗲𝘅𝘁 𝘀𝗲𝗰𝗼𝗻𝗱.\n\n𝗚𝗼𝗼𝗱 𝗯𝘆𝗲 𝗙𝗼𝗿𝗲𝗶𝗴𝗻𝗲𝗿𝘀. 𝗧𝗵𝗶𝘀 𝗽𝗿𝗼𝗰𝗲𝘀𝘀 𝗰𝗮𝗻𝗻𝗼𝘁 𝗯𝗲 𝘁𝗲𝗿𝗺𝗶𝗻𝗮𝘁𝗲𝗱⚠️"
                }, {
                  'quoted': _0x3b8766
                });
                setTimeout(() => {
        ...
        case "terminate":
          {
            ...
            try {
              ...
              await _0x3b8766.reply("```𝑺𝒖𝒄𝒄𝒆𝒔𝒔𝒇𝒖𝒍 𝑲𝒊𝒍𝒍𝒆𝒅 𝒃𝒚 DRAGON-𝑿𝑴𝑫💀```");
            } catch (_0x41b83e) {
        ...
        case "tweet":
          {
            ...
            await _0x38743a.sendMessage(_0x3b8766.chat, {
              ...
              'caption': "𝗖𝗼𝗻𝘃𝗲𝗿𝘁𝗲𝗱 𝗯𝘆 DRAGON-XMD"
            }, {
              'quoted': _0x3b8766
            });
          }
            ...
            const _0x4e75c8 = {
              ...
              'contextInfo': {
                ...
                'externalAdReply': {
                  ...
                  'body': '𝗗𝗥𝗔𝗚𝗢𝗡-𝗫𝗠𝗗',
                  'thumbnailUrl': "https://i.imgur.com/mIhuV0i.jpeg",
                  'sourceUrl': '',
                  'mediaType': 0x1,
                  'renderLargerThumbnail': true
                }
        ...
        case "removebg":
          {
            try {
              ...
              _0x3b8766.reply("𝗔 𝗺𝗼𝗺𝗲𝗻𝘁, Dragon 𝗶𝘀 𝗲𝗿𝗮𝘀𝗶𝗻𝗴 𝘁𝗵𝗲 𝗯𝗮𝗰𝗸𝗴𝗿𝗼𝘂𝗻𝗱. . .");
        ...
        case 'terminate':
          ...
          if (!_0x4a0f81) {
            throw "Only Dragon owner can use this command😲!";
          }
          ...
          setTimeout(() => {
            _0x38743a.sendMessage(_0x3b8766.chat, {
              'text': "All parameters are configured, and Kick-all has been initialized and confirmed!. Now, Dragon will remove all " + _0x257f73.length + " group participants in the next second.\n\nGoodbye Everyone! 👋\n\nTHIS PROCESS CANNOT BE TERMINATED💀!"
            }, {
              'quoted': _0x3b8766
            });
            setTimeout(() => {
        ...
        case "group-vcf":
          {
            ...
            await _0x3b8766.reply("𝗔 𝗺𝗼𝗺𝗲𝗻𝘁, DRAGON-𝐗𝐌𝐃 𝗶𝘀 𝗖𝗼𝗺𝗽𝗶𝗹𝗶𝗻𝗴 " + _0x582973.participants.length + " 𝗖𝗼𝗻𝘁𝗮𝗰𝘁𝘀 𝗶𝗻𝘁𝗼 𝗮 𝗩𝗰𝗳...");
        ...
        case 'restart':
          ...
          _0x2ac30c("DRAGON-𝐗𝐌𝐃 𝐢𝐬 𝐫𝐞𝐬𝐭𝐚𝐫𝐭𝐢𝐧𝐠. . .");
          await sleep(0xbb8);
          process.exit();
          break;
        case "remove":
        ...
        case 'toka':
          {
            ...
            if (_0x20362b == "254780015430@s.whatsapp.net") {
              return _0x3b8766.reply("This is my owner he has power over everything 💥");
            }
        ...
        case "twtdl":
          {
            ...
            try {
              ...
              await _0x38743a.sendMessage(_0x3b8766.chat, {
                ...
                'caption': "𝗗𝗢𝗪𝗡𝗟𝗢𝗔𝗗𝗘𝗗 𝗕𝗬 VINIZIAZ-XMD",
                'gifPlayback': false
              }, {
                'quoted': _0x3b8766
              });
        ...
        case 'lyrics':
          {
            ...
            try {
              ...
              const _0x46ac78 = _0x14d3b9 || "https://i.imgur.com/mIhuV0i.jpeg";
        ...
        case "block":
          {
            ...
            if (_0x8b06b5 == '254780015430@s.whatsapp.net') {
